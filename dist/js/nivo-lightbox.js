...
;(function($, window, document, undefined){
    ...
    NivoLightbox.prototype = {
        ...
        processContent: function(content, link){
            ...
            if(href.match(/\.(jpeg|jpg|gif|png)$/i) !== null){
                ...
                img.one('load', function() {
					var wrap = $('<div class="nivo-lightbox-image"></div>');
                    wrap.append(img);
            ...
            // AJAX
				...
				$.ajax({
					...
					success: function(data) {
						var wrap = $('<div class="nivo-lightbox-ajax"></div>');
						wrap.append(data);
						content.html(wrap).removeClass('nivo-lightbox-loading');
            ...
            // Inline HTML
                ...
                if($(href).length){
                    var wrap = $('<div class="nivo-lightbox-inline"></div>');
        ...
        constructLightbox: function(){
            ...
            var overlay = $('</span><div>', { 'class': 'nivo-lightbox-overlay nivo-lightbox-theme-'+ this.options.theme +' nivo-lightbox-effect-'+ this.options.effect });
